...
#'
#' Creates a weighted adjacency matrix, in which `(i,j) = x` means that
...
#' repo$attach("repoS3.R", "example source code", "source")
#'
...
#' repo$put(data1, "item1", "First item",
#'     "repo_dependencies", src="repoS3.R")
#' repo$put(data2, "item2", "Item dependent on item1", 
#'     "repo_dependencies", src="repoS3.R", depends="item1")
#' repo$put(data3, "item3", "Item dependent on item1 and item2",
#'     "repo_dependencies", src="repoS3.R", depends=c("item1", "item2"))
#'
#' ## Creating a temporary plot and attaching it
#' fpath <- file.path(repo$root(), "temp.pdf")
#' pdf(fpath)
#' plot(data1)
#' dev.off()
#' repo$attach(fpath, "visualization of item1", "plot",
#'    "repoS3.R", to="item1")
#'

...
rp$put(iris$Species, "irisLabels", "The Iris class lables.",
         c("labels", "iris", "repodemo"), src="index.Rmd")
```
...
rp$put(kiris, "iris_5clu",
         ...
         c("metadata", "iris", "kmeans", "clustering", "repodemo"),
           src="index.Rmd", depends="myiris", replace="addversion")
```
